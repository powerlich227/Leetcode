...
public class CourseScheduleIII {
    // Greedy with PQ
    // sort course[2] ascending
    // Greedy: to minimize total time
    // PQ: replace max dur as cur, if total_time > lastDay;
	...
	public static void main(String[] args) {
		...
		System.out.println(test.scheduleCourse(new int[][] {{100, 200}, {200, 1300}, {1000, 1250}, {2000, 3200}}));
		System.out.println(test.scheduleCourse(new int[][] {{1, 2}}));
		System.out.println(test.scheduleCourse(new int[][] {{3, 2}, {4, 3}}));
	}
}

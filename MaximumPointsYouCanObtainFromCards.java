...
public class MaximumPointsYouCanObtainFromCards {
    // sliding window length: n - k
    public int maxScore(int[] cardPoints, int k) {
        int res = 0, sum = 0, total = 0, n = cardPoints.length;
    ...
    public static void main(String[] args) {
    	...
    	System.out.println(test.maxScore(new int[] {2, 2, 2}, 2));
    	System.out.println(test.maxScore(new int[] {9, 7, 7, 9, 7, 7, 9}, 7));
    }
}
